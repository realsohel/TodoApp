...
const Navbar = () => {
    const {isauthenticated, setIsauthenticated ,isLoading , setIsLoading, setUser} = useContext(Context)
    ...
    <>
        <div className='bg-gray-700 text-white flex py-2 ' >
            ...
            <ul className=' mx-20 flex space-x-6 font-medium py-2'>
                ...
                <Link  to="/tasks" className='cursor-pointer hover:bg-white hover:text-gray-700 border-gray-700 text-white font-medium py-2 px-4  rounded'>Tasks</Link>
